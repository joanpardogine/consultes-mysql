...
DROP PROCEDURE IF EXISTS PardoJoan_Act_03_ProcEmm_MySQL_Apartat_008//

CREATE PROCEDURE PardoJoan_Act_03_ProcEmm_MySQL_Apartat_008()
...
DELIMITER ;
  ...
  /*
mysql>   call PardoJoan_Act_03_ProcEmm_MySQL_Apartat_008;
+-----------------------------------------------------+
