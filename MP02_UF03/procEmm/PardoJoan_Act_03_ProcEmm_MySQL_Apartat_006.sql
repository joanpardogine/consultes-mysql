...
** Nom: PardoJoan_Act_03_ProcEmm_MySQL_Apartat_006.sql
** Paràmetres:
**    Entrada:
...
mysql> mysql> SELECT titol_peli, recaudacio_peli, pressupost_peli
    ->      FROM   PELLICULES
    ->     WHERE  id_peli=1 ;
                          ^--- pi_codiPeli
+-------------+-----------------+-----------------+
...
DROP PROCEDURE IF EXISTS PardoJoan_Act_03_ProcEmm_MySQL_Apartat_006//

CREATE PROCEDURE PardoJoan_Act_03_ProcEmm_MySQL_Apartat_006(
...
DELIMITER ;
  ...
  /*
 call PardoJoan_Act_03_ProcEmm_MySQL_Apartat_006(1);
+-----------------------------------------------------+
