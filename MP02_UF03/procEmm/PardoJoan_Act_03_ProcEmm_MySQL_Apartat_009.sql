...
DROP PROCEDURE IF EXISTS PardoJoan_Act_03_ProcEmm_MySQL_Apartat_009//

CREATE PROCEDURE PardoJoan_Act_03_ProcEmm_MySQL_Apartat_009()
    BEGIN
...
/* 
 call PardoJoan_Act_03_ProcEmm_MySQL_Apartat_009();

mysql> call PardoJoan_Act_03_ProcEmm_MySQL_Apartat_009();
+----------------------------------------------------------+
| Frase                                                    |
+----------------------------------------------------------+
